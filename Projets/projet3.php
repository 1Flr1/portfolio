...
<head>
    ...
    <body>
        ...
        <?php
            ...
            $rqtProjets='SELECT logo FROM projets WHERE id=3';
            $stmtProjets=$pdo->prepare($rqtProjets);
            $rqtNom='SELECT nom FROM projets WHERE id=3';
            $stmtNom=$pdo->prepare($rqtNom);
            $rqtDesc='SELECT description FROM projets WHERE id=3';
    ...
    ?>
       ...
       <p id="desc-projet"><?php echo $desc['description'] ?></p>
        ...
        <script type="text/javascript" src="projet3.js"></script>
    </body>
</html>